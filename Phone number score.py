...
def meaning(i):
    meaning=''
    if  i in (9,14,15,19,23,24,32,36,40,41,42,44,45,46,50,51,54,55,56,59,63,64,65,69,79):
        meaning='ระดับดีมาก โอกาสประสบผลสำเร็จสูง อุปสรรคน้อย เจริญรุ่งเรือง ร่ำรวย รวดเร็ว และมีความสุข'
    elif i in (10,13,16,18,20,22,25,26,28,31,35,38,39,47,49,52,53,57,58,60,61,62,66,68,74,75):
        meaning='ระดับปานกลาง เหนื่อย มีอุปสรรค แต่ยังมีโอกาสประสบผลสำเร็จ หากมีความพยายาม'
    else:
